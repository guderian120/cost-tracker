// server.js - Express backend for Personal Cost Tracker
...
// Database pool (Supabase Postgres)
// Provide connection string via env var DATABASE_URL, e.g.
...
// Very simple hash (same as frontend previously) - replace with bcrypt for production
